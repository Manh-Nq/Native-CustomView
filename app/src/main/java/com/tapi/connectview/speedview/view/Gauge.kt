...
import com.tapi.connectview.OnSectionChangeListener
import com.tapi.connectview.OnSpeedChangeListener
import com.tapi.connectview.R
import com.tapi.connectview.doOnSections
...
abstract class Gauge constructor(
    ...
    fun isAnimmationEnd(): Boolean {
        return !speedAnimator.isRunning
    }
